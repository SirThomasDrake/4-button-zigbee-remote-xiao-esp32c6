...
Each button has 3 actions:
   ...
   1.   Single Press (reads as a toggle)
   2.   Double Press (reads as "ON")
   3.   Long Press - (2-way dimmer/brighter on a light or light group - hold to dim, release, hold to brighten)
...
Example button config:
   ...
   1.   Single Press: toggles on/off Kitchen Lights
   2.   Double Press: toggles a switch, automation, or scene
   3.   Long press: dims kitchen lights; release; long press: increase brightness on kitchen lights
...
Arduino IDE Tools Settings:
   ...
   2.   Erase All Flash Before Sketch Upload: "Enabled"
   3.   Partition Scheme: "Zigbee 4MB with spiffs"
   4.   Zigbee Mode: "Zigbee ED (end device)"
...
7. Use it in YAML for your automations
